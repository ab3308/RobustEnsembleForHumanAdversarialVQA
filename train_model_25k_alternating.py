...
def main():
    ...
    dataset_df = pd.read_excel("./Classifier_Dataset/25k_each_alternating_case.xlsx")
    ...
    train_args = {
        ...
        "best_model_dir": "./text_classifier/25k_each_alternating/",
    ...
    model_args = simpletransformers.classification.ClassificationArgs(
        ...
        overwrite_output_dir=True,
        best_model_dir="./text_classifier/25k_each_alternating/",
        output_dir="./text_classifier/25k_each_alternating_best/",
